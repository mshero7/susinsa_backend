...
public class CategoryVo {
	...
	public CategoryVo(String pre_category_name, String new_category_name, Long category_no, String category_name,
			int category_left, int category_right, Long category_product_no, int result) {
		super();
